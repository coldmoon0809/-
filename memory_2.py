...
def draw_start_screen(mouse):
    ...
    draw_text(mmm_cream, "fonts/ARCADE.TTF", 35, "Medium", (display_width / 2) , 300)
    #draw_text(mmm_cream, "fonts/ARCADE.TTF", 35, "Level feature coming soon", (display_width / 2) + 26, 370)
    setting = draw_interactive_button(mouse, 300, 50, 350, mmm_orange, mmm_orange_lite, "SETTING", False)
